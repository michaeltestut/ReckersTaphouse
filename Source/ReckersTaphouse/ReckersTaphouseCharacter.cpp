...
AReckersTaphouseCharacter::AReckersTaphouseCharacter()
{
...
void AReckersTaphouseCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AReckersTaphouseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AReckersTaphouseCharacter::Move);
...
void AReckersTaphouseCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
